...
class ProductCardGridMobileWidget extends StatefulWidget {
  const ProductCardGridMobileWidget({
    Key key,
    this.productId,
    this.prodRef,
    this.prodDoc,
  ...
  @override
  _ProductCardGridMobileWidgetState createState() =>
      _ProductCardGridMobileWidgetState();
}

class _ProductCardGridMobileWidgetState
    extends State<ProductCardGridMobileWidget> {
  @override
                    ...
                    return Builder(
                      builder: (context) {
                        ...
                        return SingleChildScrollView(
                          child: Column(
                            mainAxisSize: MainAxisSize.max,
                            children: List.generate(variante1.length,
                                (variante1Index) {
