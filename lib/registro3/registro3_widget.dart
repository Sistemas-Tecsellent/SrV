...
class _Registro3WidgetState extends State<Registro3Widget> {
  ...
  void initState() {
    ...
    textController1 = TextEditingController(
        text: valueOrDefault(currentUserDocument?.accountHolder, ''));
    textController2 = TextEditingController(
        text: valueOrDefault(currentUserDocument?.accountNo, ''));
    textController3 = TextEditingController(
        text: valueOrDefault(currentUserDocument?.clabe, ''));
    textController4 = TextEditingController(
        text: valueOrDefault(currentUserDocument?.invoicePhone, ''));
  }
