    ...
    return AuthUserStreamWidget(
      child: FutureBuilder<List<StoresRecord>>(
        ...
        builder: (context, snapshot) {
          ...
          List<StoresRecord> variantInventoryStoresRecordList = snapshot.data;
          // Return an empty Container when the document does not exist.
          if (snapshot.data.isEmpty) {
            return Container();
          }
          final variantInventoryStoresRecord =
              variantInventoryStoresRecordList.isNotEmpty
                  ? variantInventoryStoresRecordList.first
                  : null;
          return Scaffold(
            key: scaffoldKey,
            appBar: AppBar(
                                                                  ...
                                                                  children: [
                                                                    Container(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        onChanged:
                                                                            (newValue) =>
                                                                                setState(() => publicPriceSwitchMobileValue = newValue),
                                                                        title:
                                                                            Text(
                                                                          'Precio Publico',
                                                                    ...
                                                                    Container(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        onChanged:
                                                                            (newValue) =>
                                                                                setState(() => wholesalePriceSwitchMobileValue = newValue),
                                                                        title:
                                                                            Text(
                                                                          'Precio Mayoreo',
                                                                          style: FlutterFlowTheme.of(context)
                                                                    ...
                                                                    Container(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        onChanged:
                                                                            (newValue) =>
                                                                                setState(() => megaWholesalePriceSwitchMobileValue = newValue),
                                                                        title:
                                                                            Text(
                                                                          'Precio Mega Mayoreo',
                                                                          style: FlutterFlowTheme.of(context)
                                                        ...
                                                        onPressed: () async {
                                                          ...
                                                          if (updateResponses ==
                                                            ...
                                                            context.pushNamed(
                                                              ...
                                                              queryParams: {
                                                                'storeLocation': serializeParam(
                                                                    variantInventoryStoresRecord
                                                                        .location,
                                                                    ParamType
                                                                        .String),
                                                              }.withoutNulls,
                                                                          ...
                                                                          Container(
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              decoration: InputDecoration(
                                                                                labelText: 'Indica tu inventario disponible',
                                                                            ...
                                                                            children: [
                                                                              Container(
                                                                                ...
                                                                                child: SwitchListTile(
                                                                                  value: publicPriceSwitchValue ??= widget.publicPriceEnabled,
                                                                                  onChanged: (newValue) => setState(() => publicPriceSwitchValue = newValue),
                                                                                  title: Text(
                                                                                    'Precio Publico',
                                                                                    style: FlutterFlowTheme.of(context).subtitle1.override(
                                                                                          fontFamily: 'Montserrat',
                                                                              ...
                                                                              Container(
                                                                                ...
                                                                                decoration: BoxDecoration(),
                                                                                child: SwitchListTile(
                                                                                  value: wholesalePriceSwitchValue ??= widget.wholesalePriceEnabled,
                                                                                  onChanged: (newValue) => setState(() => wholesalePriceSwitchValue = newValue),
                                                                                  title: Text(
                                                                                    'Precio Mayoreo',
                                                                                    style: FlutterFlowTheme.of(context).subtitle1.override(
                                                                                          fontFamily: 'Montserrat',
                                                                              ...
                                                                              Container(
                                                                                ...
                                                                                decoration: BoxDecoration(),
                                                                                child: SwitchListTile(
                                                                                  value: megaWholesalePriceSwitchValue ??= widget.megaWholesalePriceEnabled,
                                                                                  onChanged: (newValue) => setState(() => megaWholesalePriceSwitchValue = newValue),
                                                                                  title: Text(
                                                                                    'Precio Mega Mayoreo',
                                                                                    style: FlutterFlowTheme.of(context).subtitle1.override(
                                                                                          fontFamily: 'Montserrat',
                                                                ...
                                                                children: [
                                                                  Container(
                                                                    ...
                                                                    child:
                                                                        Visibility(
                                                                      visible:
                                                                          columnVariantsRecord.discountRange1 >
                                                                              0,
                                                                      child:
                                                                          Padding(
                                                                        padding: EdgeInsetsDirectional.fromSTEB(
                                                                ...
                                                                children: [
                                                                  Container(
                                                                    ...
                                                                    child:
                                                                        Visibility(
                                                                      visible:
                                                                          columnVariantsRecord.discountRange2 >
                                                                              0,
                                                                      child:
                                                                          Padding(
                                                                        padding: EdgeInsetsDirectional.fromSTEB(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          children: [
                                                                            SwitchListTile(
                                                                              value: discount2EnabledValue ??= widget.discount2Enabled,
                                                                              onChanged: (newValue) => setState(() => discount2EnabledValue = newValue),
                                                                              title: Text(
                                                                                '${formatNumber(
                                                                                  columnVariantsRecord.discount2,
                                                                                  formatType: FormatType.percent,
                                                                ...
                                                                children: [
                                                                  Container(
                                                                    ...
                                                                    child:
                                                                        Visibility(
                                                                      visible:
                                                                          columnVariantsRecord.discountRange3 >
                                                                              0,
                                                                      child:
                                                                          Padding(
                                                                        padding: EdgeInsetsDirectional.fromSTEB(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          children: [
                                                                            SwitchListTile(
                                                                              value: discount3EnabledDesktValue ??= widget.discount3Enabled,
                                                                              onChanged: (newValue) => setState(() => discount3EnabledDesktValue = newValue),
                                                                              title: Text(
                                                                                '${formatNumber(
                                                                                  columnVariantsRecord.discount3,
                                                                                  formatType: FormatType.percent,
