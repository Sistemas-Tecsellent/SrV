...
class IngresaCostoDeEnvioAdminWidget extends StatefulWidget {
  const IngresaCostoDeEnvioAdminWidget({
    Key key,
    this.orderId,
  }) : super(key: key);
  ...
  @override
  _IngresaCostoDeEnvioAdminWidgetState createState() =>
      _IngresaCostoDeEnvioAdminWidgetState();
}

class _IngresaCostoDeEnvioAdminWidgetState
    extends State<IngresaCostoDeEnvioAdminWidget> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<AdminPricingRequestsForStoresRecord>>(
      stream: queryAdminPricingRequestsForStoresRecord(
        queryBuilder: (adminPricingRequestsForStoresRecord) =>
            adminPricingRequestsForStoresRecord.where('id',
      ...
      builder: (context, snapshot) {
        ...
        List<AdminPricingRequestsForStoresRecord>
            ingresaCostoDeEnvioAdminAdminPricingRequestsForStoresRecordList =
            snapshot.data;
        // Return an empty Container when the document does not exist.
        if (snapshot.data.isEmpty) {
          return Container();
        }
        final ingresaCostoDeEnvioAdminAdminPricingRequestsForStoresRecord =
            ingresaCostoDeEnvioAdminAdminPricingRequestsForStoresRecordList
                    .isNotEmpty
                ? ingresaCostoDeEnvioAdminAdminPricingRequestsForStoresRecordList
                    .first
              ...
              children: [
                ...
                Padding(
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      final adminPricingRequestsForStoresUpdateData =
                          createAdminPricingRequestsForStoresRecordData(
                      ...
                      await ingresaCostoDeEnvioAdminAdminPricingRequestsForStoresRecord
                          .reference
                          .update(adminPricingRequestsForStoresUpdateData);
                      context.pop();
                    },
                    text: 'Asignar costo',
                    options: FFButtonOptions(
                  ...
                  children: [
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  Container(
                                                    ...
                                                    child: Text(
                                                      ingresaCostoDeEnvioAdminAdminPricingRequestsForStoresRecord
                                                          .ownerName
                                                          .maybeHandleOverflow(
                                                              maxChars: 20),
                    ...
                    Padding(
                      ...
                      child: FutureBuilder<ApiCallResponse>(
                        future: GetPricingRequestAdminToStoreCall.call(
                        ...
                        builder: (context, snapshot) {
                          ...
                          final productosGetPricingRequestAdminToStoreResponse =
                              snapshot.data;
                          return Container(
                            width: MediaQuery.of(context).size.width * 0.9,
                            constraints: BoxConstraints(
                                  ...
                                  expanded: Builder(
                                    builder: (context) {
                                      final products = getJsonField(
                                            (productosGetPricingRequestAdminToStoreResponse
                                                    ?.jsonBody ??
                                                ''),
                                            r'''$.products''',
                                          )?.toList() ??
