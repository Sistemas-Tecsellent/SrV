...
class _$OrdersForStoresRecord extends OrdersForStoresRecord {
  ...
  factory _$OrdersForStoresRecord(
      ...
      (new OrdersForStoresRecordBuilder()..update(updates))._build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'OrdersForStoresRecord')
...
class OrdersForStoresRecordBuilder
  ...
  @override
  OrdersForStoresRecord build() => _build();

  _$OrdersForStoresRecord _build() {
    final _$result = _$v ??
