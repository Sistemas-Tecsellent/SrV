...
class _$StoreBrandsRecord extends StoreBrandsRecord {
  ...
  factory _$StoreBrandsRecord(
      ...
      (new StoreBrandsRecordBuilder()..update(updates))._build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'StoreBrandsRecord')
          ..add('id', id)
          ..add('logo', logo)
...
class StoreBrandsRecordBuilder
  ...
  @override
  StoreBrandsRecord build() => _build();

  _$StoreBrandsRecord _build() {
    final _$result = _$v ??
