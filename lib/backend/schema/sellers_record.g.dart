...
class _$SellersRecordSerializer implements StructuredSerializer<SellersRecord> {
  ...
  Iterable<Object> serialize(Serializers serializers, SellersRecord object,
    ...
    value = object.acceptedTermsAndConditions;
    if (value != null) {
      result
        ..add('acceptedTermsAndConditions')
        ..add(
            serializers.serialize(value, specifiedType: const FullType(bool)));
    }
    value = object.acceptedPrivacy;
    if (value != null) {
      result
        ..add('acceptedPrivacy')
        ..add(
    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        ...
        case 'acceptedTermsAndConditions':
          result.acceptedTermsAndConditions = serializers.deserialize(value,
              specifiedType: const FullType(bool)) as bool;
          break;
        case 'acceptedPrivacy':
          result.acceptedPrivacy = serializers.deserialize(value,
              specifiedType: const FullType(bool)) as bool;
          break;
...
class _$SellersRecord extends SellersRecord {
  ...
  bool operator ==(Object other) {
    ...
    return other is SellersRecord &&
        ...
        acceptedTermsAndConditions == other.acceptedTermsAndConditions &&
        ...
        $jc(
            $jc(
                $jc(
                                                        ...
                                                        $jc(
                                                            $jc(
                                                                $jc(
                                                                    $jc(
                                                                        $jc(
                                                                            $jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc(0, email.hashCode), displayName.hashCode), photoUrl.hashCode), uid.hashCode), createdTime.hashCode), phoneNumber.hashCode), location.hashCode), sellerId.hashCode), storeId.hashCode), weeklyEarning.hashCode), fiscalType.hashCode), fiscalName.hashCode), fiscalRFC.hashCode), fiscalAddress.hashCode), fiscalContactName.hashCode),
                    ...
                    isApproved.hashCode),
                acceptedTermsAndConditions.hashCode),
            acceptedPrivacy.hashCode),
        reference.hashCode));
  }
  ...
  String toString() {
    return (newBuiltValueToStringHelper(r'SellersRecord')
          ...
          ..add('acceptedTermsAndConditions', acceptedTermsAndConditions)
...
class SellersRecordBuilder
  ...
  bool get acceptedTermsAndConditions => _$this._acceptedTermsAndConditions;
  set acceptedTermsAndConditions(bool acceptedTermsAndConditions) =>
      _$this._acceptedTermsAndConditions = acceptedTermsAndConditions;
  ...
  SellersRecordBuilder get _$this {
    ...
    if ($v != null) {
      ...
      _acceptedTermsAndConditions = $v.acceptedTermsAndConditions;
