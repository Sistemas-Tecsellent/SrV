...
class _$PricingRequestsRecord extends PricingRequestsRecord {
  ...
  factory _$PricingRequestsRecord(
      ...
      (new PricingRequestsRecordBuilder()..update(updates))._build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'PricingRequestsRecord')
          ..add('id', id)
...
class PricingRequestsRecordBuilder
  ...
  @override
  PricingRequestsRecord build() => _build();

  _$PricingRequestsRecord _build() {
    final _$result = _$v ??
