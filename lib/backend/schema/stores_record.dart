...
abstract class StoresRecord
  ...
  @nullable
  BuiltList<String> get recentlySold;

  @nullable
  String get storePhone;

  @nullable
  BuiltList<String> get listedButNoAvailableProducts;
  ...
  static void _initializeBuilder(StoresRecordBuilder builder) => builder
    ...
    ..isApproved = false
    ..recentlySold = ListBuilder()
    ..storePhone = ''
    ..listedButNoAvailableProducts = ListBuilder()
    ..availableProducts = 0
  ...
  int availableProducts,
    ...
    serializers.toFirestore(
        ...
        StoresRecord((s) => s
          ...
          ..listedButNoAvailableProducts = null
