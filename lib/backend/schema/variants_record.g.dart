...
class _$VariantsRecord extends VariantsRecord {
  ...
  factory _$VariantsRecord([void Function(VariantsRecordBuilder) updates]) =>
      (new VariantsRecordBuilder()..update(updates))._build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'VariantsRecord')
          ..add('id', id)
          ..add('box', box)
          ..add('coupon', coupon)
          ..add('details', details)
...
class VariantsRecordBuilder
  ...
  @override
  VariantsRecord build() => _build();

  _$VariantsRecord _build() {
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'VariantsRecord', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
