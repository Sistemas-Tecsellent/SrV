...
class _$DeliverersRecord extends DeliverersRecord {
  ...
  factory _$DeliverersRecord(
      ...
      (new DeliverersRecordBuilder()..update(updates))._build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'DeliverersRecord')
          ..add('uid', uid)
...
class DeliverersRecordBuilder
  ...
  @override
  DeliverersRecord build() => _build();

  _$DeliverersRecord _build() {
    final _$result = _$v ??
