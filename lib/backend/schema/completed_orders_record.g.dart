...
class _$CompletedOrdersRecord extends CompletedOrdersRecord {
  ...
  factory _$CompletedOrdersRecord(
      ...
      (new CompletedOrdersRecordBuilder()..update(updates))._build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'CompletedOrdersRecord')
          ..add('id', id)
...
class CompletedOrdersRecordBuilder
  ...
  @override
  CompletedOrdersRecord build() => _build();

  _$CompletedOrdersRecord _build() {
    final _$result =
