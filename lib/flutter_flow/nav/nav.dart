      ...
      routes: [
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              name: 'ProductosDeMarcaBuscar',
              path: 'marca/productos/:brand/buscar',
              requireAuth: true,
              builder: (context, params) => ProductosDeMarcaBuscarWidget(
                brand: params.getParam('brand', ParamType.String),
              ),
            ),
            FFRoute(
              name: 'ProductosDeMarcaList',
              path: 'marca/productos/:brand',
              requireAuth: true,
              builder: (context, params) => ProductosDeMarcaListWidget(
                brand: params.getParam('brand', ParamType.String),
              ),
            ),
            FFRoute(
            ...
            FFRoute(
              ...
              builder: (context, params) => ProductPageWidget(
                productId: params.getParam('productId', ParamType.String),
                storeLocation:
                    params.getParam('storeLocation', ParamType.String),
              ),
            ),
            FFRoute(
